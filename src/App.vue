...
import { reactive } from 'vue';
  ...
  const getTarefasFiltradas = () => {
    const { filtro } = estado;
//O switch vai fazer varios ifes dentor do filtro... ex: caso o filtro seja pendentes retorna getTarefasPendentes.
    switch (filtro) {
      case 'pendentes': 
...
<template>
  <div class="container">
    <header class="p-5 mp-4 mt-4 bg-light rounded-3">
